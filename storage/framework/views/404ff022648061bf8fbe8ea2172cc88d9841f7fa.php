																...
																<div class="row form-row">           
																	...
																	<div class="col-12">
																		<div class="form-group">
																			...
																			<div class="cal-icon">
																				<input type="date" name="dateOfBirth" class="form-control" value="<?php echo e(Auth::user()->dateOfBirth); ?>">
																			</div>
																		</div>
																	</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/profile.blade.php ENDPATH**/ ?>