								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-12">
										<div class="form-group">
											...
											<?php if($doctor->university_degree!=null): ?>
                                                <a href="<?php echo e(asset('assets_admin/img/doctors/degree/'.$doctor->university_degree)); ?>" target="_black">
									...
									<div class="col-12 col-sm-12">
										<div class="form-group">
											...
											<?php if($doctor->practice_certificate!=null): ?>
                                                <a href="<?php echo e(asset('assets_admin/img/doctors/certificate/'.$doctor->practice_certificate)); ?>" target="_black">
									...
									<div class="col-12 col-sm-12">
										<div class="form-group">
											<!-- <embed src="<?php echo e(asset('assets_admin/img/doctors/qualification/'.$doctor->other_qualification)); ?>"  style="width:90px; height:90px;" frameborder="1"> -->
											

											<?php if($doctor->other_qualification!=null): ?>
                                                <a href="<?php echo e(asset('assets_admin/img/doctors/qualification/'.$doctor->other_qualification)); ?>" target="_black">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/doctors/edit.blade.php ENDPATH**/ ?>