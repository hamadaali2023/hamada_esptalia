								...
								<div class="row form-row">
									...
									<!-- <div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="type" class="form-control" value="<?php echo e($edit->type); ?>">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select" name="status" >
												<option value="1" <?php echo e(($edit->status=='1') ? 'selected' : ''); ?>>مفعل</option>
												<option value="0" <?php echo e(($edit->status=='0') ? 'selected' : ''); ?>>غير مفعل</option>
											</select>
										</div>
									</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/doctors/edit_servic.blade.php ENDPATH**/ ?>