		...
		<script src="<?php echo e(asset('assets_admin/plugins/bootstrap-rtl/js/bootstrap.min.js')); ?>"></script>
		...
		<script src="<?php echo e(asset('asset/js/table.min.js')); ?>"></script>
        ...
        <!--<script src="<?php echo e(asset('js/app.js')); ?>"></script>--><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/layout/partials/footer_admin-scripts.blade.php ENDPATH**/ ?>