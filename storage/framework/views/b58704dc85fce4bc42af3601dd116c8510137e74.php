								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>بنر</label>
											<input type="file"  name="pannar" class="form-control" value="<?php echo e(old('pannar')); ?>">
										</div>
									</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/pannars/all.blade.php ENDPATH**/ ?>