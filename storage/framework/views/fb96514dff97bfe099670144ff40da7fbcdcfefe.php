				...
				<div class="card author-widget clearfix">
									<div class="card-header">
										...
										<?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        								    <?php $__currentLoopData = $_item->readnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
        									 <div class="card-body">
        										<div class="about-author">
        											<div class="about-author-img">
        												<div class="author-img-wrap">
        													...
        													<!--src="<?php echo e(asset('assets_admin/img/doctors/photo/'.$_items->photo)); ?>" width="50px" height="50px">-->
        													<!--<?php else: ?> -->
        													<!--    <img class="img-fluid rounded-circle" alt="" -->
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/doctors/doctornots.blade.php ENDPATH**/ ?>