		                                    ...
		                                    <thead>
												...
												<tbody>
													...
													<tr>
														...
														<td class="text-center">
															<?php echo e(\Carbon\Carbon::parse($_item->dateOfBirth)->format('d/m/Y')); ?>
								...
								<div class="row form-row">
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="first_name_ar" class="form-control" value="<?php echo e(old('email')); ?>">
										</div>
									</div>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/patients/all.blade.php ENDPATH**/ ?>