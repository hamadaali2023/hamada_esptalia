                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3">
                        <div class="input-group ">
                          ...
                          <input type="text" name="name" id="last_name_ar"  class="form-control" />
                        </div>
                    </div>
       ...
       success:function(data)
       {
          ...
          for(var i = 0; i < data.length; i++)
          {
              ...
              output += '<td class="text-center">' + data[i].first_name_ar + '</td>';
             	output += '<td class="text-center">' + data[i].docapointment[r].date + '</td>';
              output += '<td class="text-center"><a href="doctorpdf/'+data[i].id+'"><i class="bi bi-printer"></i>print</a></td></tr>';
          	 }
             // output += '<tr>';
...
<?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/doctors/report.blade.php ENDPATH**/ ?>