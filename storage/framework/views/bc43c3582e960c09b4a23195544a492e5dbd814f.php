												...
												<tr>													
													...
													<td class="text-center">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light" href="<?php echo e(url('specialities/'.$_item->id).'/edit'); ?>"><i class="fe fe-pencil"></i> تعديل</a>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/specialities/all.blade.php ENDPATH**/ ?>