...
<div class="sidebar" id="sidebar">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<!-- <li  class="<?php echo e(Request::is('reviews') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('reviews')); ?>"><i class="fe fe-star-o"></i> <span>التقييمات</span></a>
							</li> -->
							<!-- <li  class="<?php echo e(Request::is('reviews') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('reviews')); ?>"><i class="fe fe-star-o"></i> <span>المراجعات</span></a>
							</li> -->
							...
							<li   class="<?php echo e(Request::is('countries') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('countries')); ?>"><i class="fe fe-vector"></i> <span>الدول</span></a>
							</li>
							<li   class="<?php echo e(Request::is('cities') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('cities')); ?>"><i class="fe fe-vector"></i> <span>المدن</span></a>
							</li>
							
							<li   class="<?php echo e(Request::is('doctornotifaction') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('doctornotifaction')); ?>"><i class="fe fe-vector"></i> <span>ارسال اشعارات لدكتور</span></a>
							</li>
							<li   class="<?php echo e(Request::is('patientnotifaction') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('patientnotifaction')); ?>"><i class="fe fe-vector"></i> <span>ارسال اشعارات لمريض</span></a>
							</li>
							...
							<li   class="<?php echo e(Request::is('contact') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('contact')); ?>"><i class="fe fe-vector"></i> <span>معلومات التواصل</span></a>
							</li>
							<!--<li   class="<?php echo e(Request::is('about') ? 'active' : ''); ?>"> -->
							<!--	<a href="<?php echo e(url('about')); ?>"><i class="fe fe-vector"></i> <span>من نحن</span></a>-->
							<!--</li>-->
							<li   class="<?php echo e(Request::is('privacy') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('privacy')); ?>"><i class="fe fe-vector"></i> <span>سياسية الخصوصية</span></a>
							</li>
			...
			<!-- /Sidebar<?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/layout/partials/nav_admin.blade.php ENDPATH**/ ?>