	...
	<div class="main-wrapper">
				...
				<li class="nav-item dropdown noti-dropdown">
					...
					<div class="dropdown-menu notifications">
						...
						<div class="noti-content">
							...
							<?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
								<?php $__currentLoopData = $_item->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
									...
									<li class="notification-message">
										<a href="<?php echo e(url('view/notification/'.$_item->id)); ?>">
											<div class="media">
												<span class="avatar avatar-sm">
													
													<?php if($_item->photo !=null): ?>
        										        <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/doctors/photo/'.$_item->photo)); ?>">
        										    <?php else: ?>        									             
												...
												<div class="media-body">
													<p class="noti-details">
														<span class="noti-title"><?php echo e($_items->data['name']); ?></span>
													</p>
													<p class="noti-time">
														<span class="notification-time"><?php echo e($_items->data['title']); ?></span>
													</p>
													<p class="noti-time">
							...
							<?php $__currentLoopData = $patient_notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
								<?php $__currentLoopData = $_patient->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_patients): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
									<li class="notification-message">
										<a href="<?php echo e(url('view/patient/notification/'.$_patient->id)); ?>">
											<div class="media">
												<span class="avatar avatar-sm">
													
													<?php if($_item->photo !=null): ?>
        										        <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/patients/'.$_patients->photo)); ?>">
        										    <?php else: ?>        									             
        									             <img class="avatar-img rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/profile_image.png')); ?>">
        										    <?php endif; ?>
												</span>
												<div class="media-body">
													<p class="noti-details">
														<span class="noti-title"><?php echo e($_patients->data['name']); ?></span>
													</p>
													<p class="noti-time">
														<span class="notification-time"><?php echo e($_patients->data['title']); ?>:</span>
													</p>
													<p class="noti-time">
														<span class="notification-time"><?php echo e($_patients->data['data']); ?></span>
													</p>
												</div>
											</div>
										</a>
		...
		<!-- /Header --><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/layout/partials/header_admin.blade.php ENDPATH**/ ?>