...
<div class="page-wrapper">
														...
														<div class="table-responsive">
								                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
																...
																<tr>
																	...
																	<td class="text-right">
																		<div class="actions">						
																			<a  data-toggle="modal" data-catid="<?php echo e($_item->id); ?>" data-target="#delete_apoint" class="btn btn-sm bg-danger-light">
																				<i class="fa fa-trash" aria-hidden="true" style="color: red"></i>
																			</a>
																		</div>
																	</td>												
			...
			<select name="" class="form-control formselect required" placeholder="Select Category" id="get_doctors_name">
													...
													<?php $__currentLoopData = $specialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
													   <option value="<?php echo e($_item->id); ?>" <?php echo e((old('get_doctors_name')==$_item->id)? 'selected':''); ?>><?php echo e($_item->name_ar); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
												</select>
											</div>
										</div>
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="<?php echo e(route('patients.delet.apointment')); ?>">
	                                   		 <?php echo csrf_field(); ?>
	                                         <!-- hidden -->
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/patients/patient-profile.blade.php ENDPATH**/ ?>