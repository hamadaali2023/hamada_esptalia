<meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo e(asset('assets_admin/plugins/fullcalendar/fullcalendar.min.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets_admin/css/style.css')); ?>">
        		<!--<script src="<?php echo e(asset('js/app.js')); ?>"></script>--><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/layout/partials/head_admin.blade.php ENDPATH**/ ?>