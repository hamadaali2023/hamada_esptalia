									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select" name="type" >
												<option value="خدمة واحدة" <?php echo e(($edit->type=='خدمة واحدة') ? 'selected' : ''); ?>>خدمة واحدة</option>
												<option value="باقة خدمات" <?php echo e(($edit->type=='باقة خدمات') ? 'selected' : ''); ?>>باقة خدمات</option>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/template/bootstrap/template-rtl/resources/views/admin/doctors/edit_offer.blade.php ENDPATH**/ ?>