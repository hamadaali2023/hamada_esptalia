													...
													<?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<tr>
															<td>
																...
																<img class="avatar-img rounded-circle" 
																		src="<?php echo e(asset('assets_admin/img/doctors/photo/'.$doctors->photo)); ?>" alt="User Image" width="60px" height="60px"></a>
															</td>
															<td>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-10">
															<!-- <a href="<?php echo e(asset('assets_admin/img/doctors/degree/'.$doctors->university_degree)); ?>" target="_black">
															...
															<?php if($doctors->university_degree!=null): ?>
				                                                <a href="<?php echo e(asset('assets_admin/img/doctors/degree/'.$doctors->university_degree)); ?>" target="_black">
														    	<label>عرض </label></a>    
															<?php else: ?>
													...
													<div class="row">
														...
														<p class="col-sm-10">
															<!-- <embed src="<?php echo e(asset('assets_admin/img/doctors/certificate/'.$doctors->practice_certificate)); ?>"  style="width:90px; height:90px;" frameborder="1"> -->
															<?php if($doctors->practice_certificate!=null): ?>
				                                                <a href="<?php echo e(asset('assets_admin/img/doctors/certificate/'.$doctors->practice_certificate)); ?>" target="_black">
														    	<label>عرض </label></a>    
															<?php else: ?>
													...
													<div class="row">
														...
														<p class="col-sm-10">
															<!-- <embed src="<?php echo e(asset('assets_admin/img/doctors/certificate/'.$doctors->other_qualification)); ?>"  style="width:90px; height:90px;" frameborder="1"> -->
															<?php if($doctors->other_qualification!=null): ?>
				                                                <a href="<?php echo e(asset('assets_admin/img/doctors/qualification/'.$doctors->other_qualification)); ?>" target="_black">
														    	<label>عرض </label></a>    
															<?php else: ?>
								...
								<div class="row form-row">
									...
									<div class="col-md-4 row" 
										...
										<div class="form-group">
											...
											<label>من </label>
											<div class="">
												<input type="text" name="from_morning" class="form-control" id="from_morning" >
											</div>
										</div>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="form-group">
											...
											<label>الى</label>
											<div class="">
												<input type="text" name="to_morning" class="form-control"id="tomorning">
											</div>
										</div>
									</div>
									<div class="col-md-4 row" 
										...
										<div class="form-group">
											...
											<label>من </label>
											<div class="">
												<input type="text" class="form-control" name="from_afternoon" id="fromafternoon" >
											</div>
										</div>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="form-group">
											...
											<label>الى</label>
											<div class="">
												<input type="text" class="form-control" name="to_afternoon" id="toafternoon" >
											</div>
										</div>
									</div>
									...
									<div class="col-md-4 row" 
										...
										<div class="form-group">
											...
											<label>من</label>
											<div class="">
												<input type="text" class="form-control" name="from_evening" id="fromevening" >
											</div>
										</div>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="form-group">
											...
											<label>الى</label>
											<div class="">
												<input type="text" class="form-control" name="to_evening" id="toevening" >
											</div>
										</div>
									</div>
									<br/>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select" name="status" >
												...
												<option value="0" <?php echo e((old('status')=='0')? 'selected':''); ?>>غير مفعل</option>
											</select>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control select" name="type" >
												...
												<option value="خدمة واحدة" <?php echo e((old('type')=="خدمة واحدة")? 'selected':''); ?>>خدمة واحدة</option>
												<option value="باقة خدمات" <?php echo e((old('type')=="باقة خدمات")? 'selected':''); ?>>باقة خدمات</option>
											</select>
										</div>
									</div>
									<div class="col-12 col-sm-12">
										...
										<div class="form-group">
											...
											<select class="form-control select" name="specialityId">
												...
												<?php $__currentLoopData = $specialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												   <option value="<?php echo e($_item->id); ?>" <?php echo e((old('specialityId')==$_item->id)? 'selected':''); ?> ><?php echo e($_item->name_ar); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control select" name="specialityId">
												...
												<?php $__currentLoopData = $specialities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												   <option value="<?php echo e($_item->id); ?>" <?php echo e((old('specialityId')==$_item->id)? 'selected':''); ?>><?php echo e($_item->name_ar); ?> - <?php echo e($_item->name_en); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $('#edit').on('show.bs.modal', function (event) {
      ...
      modal.find('.modal-body #from_morning').val(from_morning);
	...
	$('#delete_offers').on('show.bs.modal', function (event) {
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/doctors/doctor-profile.blade.php ENDPATH**/ ?>