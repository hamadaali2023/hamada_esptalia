									...
									<div class="card-body">
										<form action="<?php echo e(url('settings/update')); ?>" method="POST" 
											...
											<div class="form-group">
												...
												<input type="text" name="title_ar" class="form-control" value="<?php echo e($contactInfo->title_ar); ?>">
											</div>
											<div class="form-group">
												<label>العنوان انجليزي</label>
												<input type="text" name="title_en" class="form-control" value="<?php echo e($contactInfo->title_en); ?>">
											</div>
											<div class="form-group">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/beaunqrp/public_html/sub/template/bootstrap/template-rtl/resources/views/admin/settings/settings.blade.php ENDPATH**/ ?>