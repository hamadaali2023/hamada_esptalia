...
class HomeController extends Controller
{
    ...
    public function addNewOffer(Request $request)
    {
        ...
        // dd(intval($percent));
            ...
            $message="تم إضافة عرض من قبل ";

            $doctor->notify(new \App\Notifications\DoctorNewNotification($doctor->first_name_en,$doctor->id,$message,$doctor->photo,$add->offer_name_ar,$add->description_ar));
     ...
     public function getServices(Request $request)
    {
        ...
        foreach ($services as $item) {
            $durationdoctorrrr= WorkingDays::where('doctorId',$request->doctorId)->first(); 
            if($durationdoctorrrr){
    ...
    public function addArticle(Request $request)
    {
        ...
        $message="تم اضافة مقال من قبل  ";
        $doctor->notify(new \App\Notifications\DoctorNewNotification($doctor->first_name_en,$doctor->id,$message,$doctor->photo,$add->title_ar,$add->description_ar));
    ...
    public function addDiagnosis(Request $request)
    {
        ...
        // dd('utguguyuyb');
        // dd($request->all());
        // $diagnostic = Diagnostic::where('id',$request->id)->first();
        // dd($diagnostic);
        if($request->id ==null){
