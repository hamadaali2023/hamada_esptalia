...
// dd('token');
    ...
    public function register(Request $request)
    {
        ...
        if($checkemail){
            ...
            $message="تم تسجيل مريض جديد باسم";
            $patient = Patient::where('id',$add->id)->first();  

            $patient->notify(new \App\Notifications\PatientNewNotification($patient->first_name_ar,$patient->id, $message,$patient->photo,$add->title_ar,$add->description_ar));
